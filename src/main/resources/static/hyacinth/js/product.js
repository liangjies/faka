				...
				,yes: function(layero){
					...
					if(grouppassword.length>0){
						...
						$.ajax({
							...
							type: 'POST',
							dataType: 'json',
							data: {'tid': data.value,'password':grouppassword},
							beforeSend: function () {
							},
				...
				,yes: function(layero){
					...
					if(productpassword.length>0){
						...
						$.ajax({
							...
							type: 'POST',
							dataType: 'json',
							data: {'pid': data.value,'password':productpassword},
							beforeSend: function () {
							},
							success: function (res) {
								if (res.code == '1') {
			...
			.done(function(res) {
				if (res.code == '1') {
					...
					if(oid.length>0){
						...
						document.cookie="oid="+res.data.oid+";" +expires;
				...
				,yes: function(layero){
					...
					if(productpassword.length>0){
						...
						$.ajax({
							...
							type: 'POST',
							dataType: 'json',
							data: {'pid': pid,'password':productpassword},
							beforeSend: function () {
							},
							success: function (res) {
								if (res.code == '1') {

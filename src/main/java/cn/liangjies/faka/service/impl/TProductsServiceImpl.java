...
public class TProductsServiceImpl implements TProductsService {
     ...
     */
    @Override
    public  List<TProducts> queryByTid(Integer tid){
        return this.tProductsDao.queryByTid(tid);
    }
     ...
     */
    @Override
    public List<TProducts> queryActiveData(){
        return this.tProductsDao.queryActiveData();
    }
